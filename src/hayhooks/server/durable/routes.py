...
def add_durable_api_routes(  # noqa: C901, PLR0915 - route-local handlers share generated models
    ...
    *,
    ...
    async def get_execution(execution_id: str, owner_id: str | None, enforce_owner: bool) -> Any:
    ...
    if deployment.resume_type is not None:
        ...
        update_parameter = signature.parameters["update"].replace(
            annotation=deployment.resume_type,
            default=Body(),
        )
