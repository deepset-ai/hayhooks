...
You can also deploy pipelines using the HTTP API endpoints: `POST /deploy_files` (PipelineWrapper files) or `POST /deploy-yaml` (YAML pipeline definition). See the [API Reference](../../reference/api-reference/#pipeline-management) for details.
...
Alternatively, use the [API endpoints](../../reference/api-reference/#pipeline-management) (`POST /deploy_files` or `POST /deploy-yaml`).
...
- [Configuration](../configuration/) - Learn about advanced configuration
- [Examples](../../examples/overview/) - Explore more examples
- [Open WebUI Integration](../../features/openwebui-integration/) - Deep dive into Open WebUI integration
