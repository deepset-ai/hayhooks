...
Includes all standard features plus [MCP Server](../../features/mcp-support/) support for integration with AI development tools like Cursor and Claude Desktop.
...
- [Configuration](../configuration/) - Configure Hayhooks for your needs
