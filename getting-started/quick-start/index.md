...
For the fastest setup with Open WebUI integration, see [Quick Start with Docker Compose](../quick-start-docker/).

## Next Steps

- [Pipeline Deployment](../../concepts/pipeline-deployment/) - Learn deployment methods
