...
See [PipelineWrapper: include_outputs_from](../pipeline-wrapper/#accessing-intermediate-outputs-with-include_outputs_from) for examples.
...
- [PipelineWrapper](../pipeline-wrapper/) - For advanced features like streaming and chat completion
