...
This page provides opinionated, Hayhooks-specific recommendations for running a secure and reliable production deployment. For infrastructure-level guidance (Docker, Kubernetes, scaling), see [Deployment Guidelines](https://deepset-ai.github.io/hayhooks/deployment/deployment_guidelines/index.md).
...
See [Environment Variables Reference](https://deepset-ai.github.io/hayhooks/reference/environment-variables/#cors) for all CORS settings.
...
See [Logging](https://deepset-ai.github.io/hayhooks/reference/logging/index.md) for log format and observability details.
...
Runtime deploy/undeploy via the API is useful during development but introduces consistency risks in multi-worker or multi-instance setups. See [Deployment Guidelines](https://deepset-ai.github.io/hayhooks/deployment/deployment_guidelines/#pipeline-deployment-strategy) for details.
...
See [Environment Variables Reference](https://deepset-ai.github.io/hayhooks/reference/environment-variables/#deploy-performance) for all deploy tuning options.
...
See [Deployment Guidelines](https://deepset-ai.github.io/hayhooks/deployment/deployment_guidelines/#async-pipelines) for more async examples.
...
Even with multiple workers, each worker has its own GIL. For truly CPU-intensive workloads, horizontal scaling (more pods/containers) is more effective than vertical scaling (more workers in one process). See [Deployment Guidelines](https://deepset-ai.github.io/hayhooks/deployment/deployment_guidelines/#horizontal-scaling) for details.
...
- **Custom middleware** -- add your own FastAPI middleware via [programmatic customization](https://deepset-ai.github.io/hayhooks/advanced/advanced-configuration/index.md)
...
- [Deployment Guidelines](https://deepset-ai.github.io/hayhooks/deployment/deployment_guidelines/index.md) -- Infrastructure, Docker, Kubernetes, and scaling
...
- [Development Best Practices](https://deepset-ai.github.io/hayhooks/guides/development-best-practices/index.md) -- Tips for local development workflow
