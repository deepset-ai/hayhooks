...
| Custom Tracing                            | [tracing.md](https://deepset-ai.github.io/hayhooks/reference/tracing/index.md)                            | [GitHub](https://github.com/deepset-ai/hayhooks/tree/main/examples/pipeline_wrappers/custom_tracing)                 | Direct OpenAI-based YAML classifier (`io_bound` vs `cpu_bound`) with nested custom tracing spans |
...
| Open WebUI Reasoning Agent (GPT-5.4 mini) | [openai-compatibility.md](https://deepset-ai.github.io/hayhooks/features/openai-compatibility/index.md)   | [GitHub](https://github.com/deepset-ai/hayhooks/tree/main/examples/pipeline_wrappers/reasoning_agent)                | Streams reasoning summaries to Open WebUI "Thinking" blocks using `OpenAIResponsesChatGenerator` |
| Responses File Upload (Server-side tools) | [openai-compatibility.md](https://deepset-ai.github.io/hayhooks/features/openai-compatibility/index.md)   | [GitHub](https://github.com/deepset-ai/hayhooks/tree/main/examples/pipeline_wrappers/responses_with_file_upload)     | Responses API file reading/upload via server-side agent tools                                    |
| Agent Codex (Client-Side Tools)           | [openai-compatibility.md](https://deepset-ai.github.io/hayhooks/features/openai-compatibility/index.md)   | [GitHub](https://github.com/deepset-ai/hayhooks/tree/main/examples/pipeline_wrappers/agent_codex)                    | Hybrid Responses API demo: server weather tool + Codex client-side tools (`exec_command`)        |
...
| API Key Authentication                     | [advanced-configuration.md](https://deepset-ai.github.io/hayhooks/advanced/advanced-configuration/index.md) | [GitHub](https://github.com/deepset-ai/hayhooks/tree/main/examples/programmatic/api_key_auth) | Middleware-based API key auth with multi-key support and Swagger Authorize |
