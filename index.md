...
Or [integrate it with Open WebUI](features/openai-compatibility/#open-webui-integration) and start chatting with it!
...
- [Quick Start Guide](getting-started/quick-start/) - Get started with Hayhooks
- [Installation](getting-started/installation/) - Install Hayhooks and dependencies
- [Configuration](getting-started/configuration/) - Configure Hayhooks for your needs
- [Examples](examples/overview/) - Explore example implementations
