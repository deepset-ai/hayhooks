...
| Custom Tracing | [tracing.md](../reference/tracing.md) | [GitHub](https://github.com/deepset-ai/hayhooks/tree/main/examples/pipeline_wrappers/custom_tracing) | Direct OpenAI-based YAML classifier (`io_bound` vs `cpu_bound`) with nested custom tracing spans |
...
| Open WebUI Reasoning Agent (GPT-5.4 mini) | [openai-compatibility.md](../features/openai-compatibility.md) | [GitHub](https://github.com/deepset-ai/hayhooks/tree/main/examples/pipeline_wrappers/reasoning_agent) | Streams reasoning summaries to Open WebUI "Thinking" blocks using `OpenAIResponsesChatGenerator` |
| Responses File Upload (Server-side tools) | [openai-compatibility.md](../features/openai-compatibility.md) | [GitHub](https://github.com/deepset-ai/hayhooks/tree/main/examples/pipeline_wrappers/responses_with_file_upload) | Responses API file reading/upload via server-side agent tools |
| Agent Codex (Client-Side Tools) | [openai-compatibility.md](../features/openai-compatibility.md) | [GitHub](https://github.com/deepset-ai/hayhooks/tree/main/examples/pipeline_wrappers/agent_codex) | Hybrid Responses API demo: server weather tool + Codex client-side tools (`exec_command`) |
...
| Durable Chat with Website | [chat-with-website.md](chat-with-website.md#durable-execution) | [GitHub](https://github.com/deepset-ai/hayhooks/tree/main/examples/durable_chat_with_website) | Familiar website Q&A graph with Pipeline checkpoints, retries, inspection, and cancellation |
