...
Looking to integrate with Open WebUI? Check out the complete [Open WebUI Integration](../openwebui-integration/) guide for detailed setup instructions, event handling, and advanced features.
...
- **Open WebUI Ready**: Full support for [Open WebUI](../openwebui-integration/) with events and tool call interception
...
If you customize your Pipeline wrapper to emit [Open WebUI Events](../openwebui-integration/#open-webui-events), it may break out-of-the-box compatibility with Haystack's `OpenAIChatGenerator`.
...
- [Open WebUI Integration](../openwebui-integration/) - Use Hayhooks with Open WebUI chat interface
- [Examples](../../examples/overview/) - Working examples and use cases
- [File Upload Support](../file-upload-support/) - Handle file uploads in pipelines
