...
- **Open WebUI Ready**: Full support for [Open WebUI](https://deepset-ai.github.io/hayhooks/features/openwebui-integration/index.md) with events, tool call interception, and reasoning display
...
By default, the Files API returns file metadata (id, filename, size) but does not persist file bytes. See the [file store example](https://deepset-ai.github.io/hayhooks/examples/overview/index.md) for how to implement custom file storage.
...
Server-side tool calls and agentic clients
